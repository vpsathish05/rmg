...
import { useForecast, useForecastInsights, useMLRevenueForecast, useMLClusterForecast, useMLResourceForecast, useMLCOEGap, useMLProjectForecast, useMLActuals } from "@/lib/hooks";
import {
  Table, TableBody, TableCell, TableHead, TableHeader, TableRow,
} from "@/components/ui/table";
import { Sparkles, TrendingUp, Target, BarChart3, Search, AlertTriangle, Clock, PoundSterling, Users, Calendar, Brain, FileText, X } from "lucide-react";
import {
...
export default function ForecastPage() {
  const [tab, setTab] = useState<"ai" | "insights" | "pipeline">("ai");
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <div className="bg-white rounded-2xl p-4 border border-gray-100">
          ...
          <p className="text-xl font-bold mt-1" style={{ color: "#FF6196" }}>{resources ? Object.values(resources.hiring_gap).reduce((s: number, v: number) => s + v, 0) : 0}</p>
          <p className="text-[10px] text-gray-400">Across roles</p>
        </div>
        <div className="bg-white rounded-2xl p-4 border border-gray-100">
          ...
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={revenueChartData}>
                ...
                <Area type="monotone" dataKey="p10" stroke="none" fill="#19105B08" name="P10" />
